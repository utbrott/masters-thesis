...
\section{\label{sect:network-power-params}Badanie poboru prądu i zużycia energii}
\subsection{\label{sect:network-modules-current-draw}Badanie poboru prądu przez moduły sieci}
\subsection{\label{sect:network-work-on-battery}Maksymalny teoretyczny czas pracy sieci}