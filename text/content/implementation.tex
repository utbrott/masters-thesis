...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{schematics/network-schematic}
...
\lstinputlisting[
    language=C++,
    linerange={6-8},
    caption={Definicje funkcji dla preprocesora pozwalające na uzyskanie ID danej, ID modułu lub rozmiaru tablicy},
    label={lst:globals-preproc},
    float=htb,
...
\lstinputlisting[
    language=C++,
    linerange={20-26},
    caption={Definicja struktury szablonowej z polami o~jednej wartości},
    label={lst:globals-template-single},
    float=htb,
]{lora-psn/include/globals.h}
...
\lstinputlisting[
    language=C++,
    linerange={33-39},
    caption={Definicja struktury szablonowej z polami w postaci tablic},
    label={lst:globals-template-array},
    float=htb,
]{lora-psn/include/globals.h}
...
\lstinputlisting[
    language=C++,
    linerange={20-26},
    caption={Definicja funkcji wykorzystywana do wysyłania sformatowanych wiadomości przez port szeregowy},
    label={lst:debug},
    float=htb,
...
\lstinputlisting[
    language=C++,
    linerange={135-144},
    caption={Funkcja implementująca podprogram zbierania danych z sieci},
    label={lst:master-fetch-subroutine},
    float=htb
]{lora-psn/src/main.cpp}
...
\lstinputlisting[
    language=C++,
    linerange={152-163},
    caption={Kod odpowiedzialny za realizację oczekiwania na odpowiedź},
    label={lst:master-fetch-timeout},
    float=htb,
]{lora-psn/src/main.cpp}
...
\lstinputlisting[
    language=C++,
    linerange={166-172},
    caption={Funkcja realizująca sprawdzenie, czy identyfikator zawarty w odpowiedzi jest poprawny},
    label={lst:master-bad-response},
    float=htb,
]{lora-psn/src/main.cpp}
...
\lstinputlisting[
    language=C++,
    linerange={189-200},
    caption={Fragment funkcji wykorzystywana do logowania wartości przez port szeregowy},
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.25\textwidth]{feather-ws/images/firmware-flowchart}
...
\lstinputlisting[
    language=C++,
    linerange={78-79,84-89},
    caption={Implementacja funkcji do dekodowania danych -- zmiana wejściowgo ciągu (string) do tablicy znaków},
    label={lst:webserver-decodestr-1},
    float=htb
]{feather-ws/src/main.cpp}
...
\lstinputlisting[
    language=C++,
    linerange={96-104,125-125},
    caption={Dekodowanie transmisji -- podział tablicy na klucze z wartościami},
    label={lst:webserver-decodestr-2},
    float=htb
]{feather-ws/src/main.cpp}
...
\lstinputlisting[
    language=C++,
    linerange={107-124},
    caption={Dekodowanie transmisji -- przypisanie wartości do odpowiednich zmiennych},
    label={lst:webserver-decodestr-3},
    float=htb
]{feather-ws/src/main.cpp}